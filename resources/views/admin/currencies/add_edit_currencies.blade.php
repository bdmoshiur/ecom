    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            @endif
                ...
                <form
                    @if (empty($currency['id'])) action="{{ route('admin.add.edit.currency') }}"
                    @else
                        action="{{ route('admin.add.edit.currency', $currency['id']) }}" @endif
                    name="currencyForm" id="currencyForm" method="POST">
                    @csrf
