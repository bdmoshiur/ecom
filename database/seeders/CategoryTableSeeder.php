...
class CategoryTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $categoryRecords = [
            ...
            'discription'=>'','url'=>'t-shirts','meta_title'=>'','meta_description'=>'','meta_keywords'=>'','status'=>1],

            ['id'=>2,'parent_id'=>0,'section_id'=>2,'category_name'=>'Casual T-Shirts','category_image'=>'','category_discount'=>0,
            'discription'=>'','url'=>'casul-t-shirts','meta_title'=>'','meta_description'=>'','meta_keywords'=>'','status'=>1]
        ];
